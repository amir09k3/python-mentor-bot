...
from utils.code_runner import run_code_safely
from utils.exercise_evaluator import evaluate_exercise
from utils.code_quality import analyze_code_quality
from utils.knowledge_base import understand_and_respond
from utils.ai_engine import query_llama3
...
# --- Import لایه داده ---
from models.database import init_db, add_user, get_user
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "📊 پروفایل شما ذخیره شد: ID={user.id}"
    )
...
async def help_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = (
        ...
        "/hint — دریافت راهنمایی برای تمرین جاری (فقط هنگام انجام تمرین)\n\n"
        "🔹 نحوه استفاده:\n"
        "۱. ابتدا /start بزنید\n"
